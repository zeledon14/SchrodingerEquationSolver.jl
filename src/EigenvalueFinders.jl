...
function find_eigenvalue_intervals_v(energy_grid::Vector{Float64},v_effe::Vector{Float64}, grid_stru::Any, 
    initial_condition_function::Function;
    l::Int64=0)::Tuple{Vector{Tuple{Float64,Float64}},Vector{Tuple{Float64,Float64}}}
