...
- `grid::Vector{Float64}`: A list with the space points.
"""
    function AtomBasisSet(Z::Int64, grid::Vector{Float64})::AtomBasisSet
        ...
        E_xc::Float64=0.0
        V_xc::Float64=0.0
        return AtomBasisSet(Name,Energy,E_hartree,
                                E_xc,V_xc,
                                grid,orbitals)
        
    end

    function save_basis_set(in_basis::AtomBasisSet, save_path::String)    
