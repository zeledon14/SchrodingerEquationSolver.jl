...
@testset "H_TEST" begin
    ...
    u_fwd_i= IntegralNumericalMethods.integrate_second_order_DE_RK4_PCABM5_on_grid_i(grid_i,g,f,dx_di,
    u1,w1);
...
@testset "H_test_initial_conditions_solver_uniform_integer_grid" begin
    ...
    u_end, w_end=InitialConditions.exponenetial_deacy_r_ref(r_max, E);
